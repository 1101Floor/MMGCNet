...
def train(args, epoch, CIE_MGCN, sampler, optimizer, scheduler, loader_train, div_cfg):
    ...
    for cnt, batch in enumerate(loader_train):
        ...
        dec_motion, sampler_dist, vae_dist, _ = sampler.forward(CIE_MGCN)  # [T N sn 2]
...
''' === set model === '''
CIE_MGCN = CIE_MGCN(args)  # load CIE_MGCN
...
for epoch in range(args.num_epochs):
    train(args, epoch, CIE_MGCN, sampler, optimizer, scheduler, loader_train, div_cfg)
